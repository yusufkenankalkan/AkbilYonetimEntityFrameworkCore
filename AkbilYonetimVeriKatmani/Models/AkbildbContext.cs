...
namespace AkbilYonetimVeriKatmani.Models;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AkbilNo).HasName("PK__Akbiller__ADBC6456CA5F5813");
            ...
            entity.Property(e => e.AkbilNo)
                ...
                .IsUnicode(false)
                .IsFixedLength();
            entity.Property(e => e.AkbilSahibiId).HasColumnName("AKbilSahibiId");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Kullanic__3214EC07EDEE3434");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Talimatl__3214EC0741234B75");
